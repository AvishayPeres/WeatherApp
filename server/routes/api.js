...
const API_KEY = '8607d5cef2754b82b3281718191104'


router.get('/city/:cityName', function (req, res) {
    let cityName = req.params.cityName
    request(`http://api.apixu.com/v1/forecast.json?key=${API_KEY}&q=${cityName}`, (err, response) => {
        ...
        let cityInfo = {
            ...
            conditionPic: weatherInfo.weatherIcon
        }
        res.send(cityInfo)
    })
